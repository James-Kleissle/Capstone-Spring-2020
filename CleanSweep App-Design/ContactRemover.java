...
public class ContactRemover extends AppCompatActivity {
    Toolbar toolbar;
    ListView listView;
    ...
    //Declaring method for deleting contacts
    private void deleteContacts() {
        ...
        for (int i = 0; i < checked.size(); i++) {
            if (checked.valueAt(i) == true) {
                ...
                com.hfad.cleansweep.ContactHelper.deleteContact(getContentResolver(), phoneNumber);
            }
        }
        phones.close();
    ...
    private void showContacts() {
        Cursor cursor = com.hfad.cleansweep.ContactHelper.getContactCursor(getContentResolver(),"");
