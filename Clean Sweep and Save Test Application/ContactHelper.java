//Katelynn Tafoya 1-24-20
package com.example.cleansweepandsave.Helper;
...
public class ContactHelper {
    ...
    public static Cursor getContactCursor(ContentResolver contactHelper,String starttsWith)
    {
        ...
        Cursor cur = null;
        try{
            if(starttsWith != null && !starttsWith.equals(""))
            {
                cur = contactHelper.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,
                        projection,ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME + "line \""
                                + starttsWith + "%\"",null,ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME
                                + " ASC");
            }
            else
            {
