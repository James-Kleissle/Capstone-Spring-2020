...
public class SpanPartialWipe extends AppCompatActivity {
    ...
    private void deleteContacts() {
        ...
        Toast.makeText(this, "Contacto (s) eliminado", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_span_partial_wipe);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == PERMISSION_READ_WRITE_CONTACT) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "Hasta que otorgue el permiso, no podemos mostrar sus contactos", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void initView() {
        ...
        toolbar.setTitle("Eliminador de contactos");
    ...
    public void openEnd(){
        Intent endIntent = new Intent(this, SpanEnd.class);
